...
import SimulationParPositionActuel from "@/components/processus/SimulationParPositionActuel";
import SimulationParPositionRecommande from "@/components/processus/SimulationParPositionRecommande";

const SimulationParPosition = () => {
  ...
  return (
    <div className="bg-slate-50">
      <div className="max-w-full mx-auto p-4 space-y-4">
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <h1 className="text-2xl font-bold text-gray-900">
                    Simulation par{" "}
                    <span className="text-[#005EA8]">Position</span>
                  </h1>
                </div>
                <p className="text-xs text-gray-500 ml-3 font-medium ">
                  Processus {isRecommended ? "optimisé" : "actuel"} • Analyse
                  détaillée
                </p>
              </div>
        ...
        {/* Content */}
        {isRecommended ? (
          <SimulationParPositionRecommande />
        ) : (
          <SimulationParPositionActuel />
        )}
      </div>
    </div>
  );
...
export default SimulationParPosition;
