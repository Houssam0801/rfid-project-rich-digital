...
import { simulationGlobaleDataActuel } from "../../data/simulationGlobale";
import EffectifComparisonModalActuel from "../EffectifComparisonModalActuel";
import ExcelJS from "exceljs";

export default function SimulationGlobaleActuel() {
  // Form inputs
  ...
  const currentResults = showResults ? simulationGlobaleDataActuel : null;
  ...
  const handleExporterExcel = async () => {
    ...
    try {
      ...
      const worksheet = workbook.addWorksheet("Simulation_Globale_Actuel");
      ...
      link.href = url;
      link.download = "Simulation_Globale_Actuel.xlsx";
  ...
  return (
    <div className="max-w-full mx-auto space-y-4">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
        ...
        <div className="p-4">
          {/* Form inputs and Summary Cards - full width */}
          <div className="space-y-4">
            {/* Inputs grid - 5 inputs in one line */}
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-md transition-shadow">
        <div className="border-b border-gray-200 px-4 py-1 bg-gradient-to-r from-gray-50 to-blue-50 rounded-t-xl text-center">
          <h3 className="text-base font-bold text-gray-900">
            Résultats de Simulation Globale - Actuel
          </h3>
        </div>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-6xl w-full max-h-[90vh] overflow-auto">
            <div className="border-b border-gray-200 px-6 py-4 flex items-center justify-between sticky top-0 bg-white">
              <h3 className="text-xl font-semibold text-gray-900 flex items-center gap-2">
                ...
                Besoin Effectifs (Arrondi) par Position - Processus Actuel
              </h3>
              <button
