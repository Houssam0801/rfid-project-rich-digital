...
const navItems = [
  ...
  { id: "articles", label: "Produits", icon: Package, path: "/articles" },
...
export default function Header() {
  ...
  const NavLink = ({ item, isMobile = false }) => {
    ...
    const buttonClass = isMobile
      ...
      : `flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 gap-1 ${
          active
    ...
    if (isMobile) {
      ...
      return (
        <div className="space-y-1">
          <div
            className={`flex items-center justify-start space-x-3 p-3 w-full rounded-lg ${
      ...
      <div className="max-w-[98%] mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center">
            <img
              src="/images/logo_RFID.png"
              alt="RFID TrackerPro Logo"
